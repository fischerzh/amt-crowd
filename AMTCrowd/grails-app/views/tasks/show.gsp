	...
	<body>
		...
		<div id="show-tasks" class="content scaffold-show" role="main">
			...
			<ol class="property-list tasks">
				...
				<g:if test="${tasksInstance?.description}">
				<li class="fieldcontain">
					<span id="description-label" class="property-label"><g:message code="tasks.description.label" default="Description" /></span>
					
						<span class="property-value" aria-labelledby="description-label"><g:fieldValue bean="${tasksInstance}" field="description"/></span>
				...
				<li class="fieldcontain">
					<span id="assignment-label" class="property-label"><g:message code="tasks.assignment.label" default="Assignment" /></span>
						...
						<span class="property-value" aria-labelledby="assignment-label"><g:fieldValue bean="${tasksInstance}" field="assignment"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${tasksInstance?.level}">
				<li class="fieldcontain">
					<span id="level-label" class="property-label"><g:message code="tasks.level.label" default="Level" /></span>
					
						<span class="property-value" aria-labelledby="level-label"><g:fieldValue bean="${tasksInstance}" field="level"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${tasksInstance?.result}">
				<li class="fieldcontain">
					<span id="result-label" class="property-label"><g:message code="tasks.result.label" default="Result" /></span>
					
						<span class="property-value" aria-labelledby="result-label"><g:fieldValue bean="${tasksInstance}" field="result"/></span>
